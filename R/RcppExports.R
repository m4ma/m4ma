...
#' a row for each line.
object2lines_rcpp <- function(o) {
    .Call(`_m4ma_object2lines_rcpp`, o)
}
...
bodyObjectOverlap_rcpp <- function(oL, r, okCentres) {
    .Call(`_m4ma_bodyObjectOverlap_rcpp`, oL, r, okCentres)
}
...
bodyObjectOK_rcpp <- function(r, centres, objects, ok) {
